...
public class MenuVictoire extends GameState {
    private Texture background;
    private BitmapFont VictoireTitleText, resumeText, InventaireText, exitText;
    private GlyphLayout VictoireTitleGlyph, resumeGlyph, InventaireGlyph, exitGlyph;
    private boolean actionlocked = false;

    private GameStateManager gameStateManager;

    public MenuVictoire(GameStateManager gsm) {
        super(gsm);
        ...
        // Titre
        this.VictoireTitleText = new BitmapFont();
        this.VictoireTitleText.getData().setScale(1.5f);
        this.VictoireTitleGlyph = new GlyphLayout();
        this.VictoireTitleGlyph.setText(this.VictoireTitleText, "Victoire");
    ...
    public void render(SpriteBatch sb) {
        ...
        VictoireTitleText.draw(sb, VictoireTitleGlyph, (Gdx.graphics.getWidth() - VictoireTitleGlyph.width) / 2, Gdx.graphics.getHeight() - 150);
    ...
    public void dispose() {
        ...
        this.VictoireTitleText.dispose();

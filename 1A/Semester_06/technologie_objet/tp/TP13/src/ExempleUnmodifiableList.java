...
public class ExempleUnmodifiableList {
	...
	*/
	public static void consulter(List<Integer> nombres, int entier) {
		...
		int frequence = frequency(nombres, entier);	// fréquence de entier dans nombres ?
		...
		// Afficher la fréquence de entier dans nombres
		int nouvelle_frequence = frequency(nombres, entier);	// fréquence de entier dans nombres ?

...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		Ptr1.all := 5;
		Put_Line ("Ptr1.all = " & Integer'Image (Ptr1.all));
                Free(Ptr1);     -- libération de la mémoire occupée par Ptr1
	...
	begin
		...
		-- Vagrind va nous indiquer une perte de mémoire car la valeur pointée
                -- par Ptr2 n'a pas été libéré.
                --
	...
	begin
		...
		-- d'appeler Detruire dessus ?
                -- Oui car la pile a été allouée dans la zone de mémoire dynamique
